...
<?php include('header.php'); ?>
		<main class="pure-g">
			...
			<form action="/session.php" method="post" class="pure-u-9-24 pure-form pure-form-stacked">
				...
				<input type="email" name="mail" required autocomplete="on" placeholder="email" class="pure-input-1" <?=(isset($_SESSION['f_mail']))?'value="'.$_SESSION['f_mail'].'"':'';?>>
				<label for="mdp">password</label>
				<input type="password" name="mdp" required placeholder="password" class="pure-input-1">
			...
			<form action="/session.php" method="post" class="pure-u-9-24 pure-form pure-form-stacked">
				...
				<fieldset class="pure-group">
					<input type="password" name="mdp"  required placeholder="password" class="pure-input-1">
					<input type="password" name="mdpc" required placeholder="verifi password" class="pure-input-1">
				</fieldset>
